...
// Выходные данныеЗамените все продукты в поваренной книге Васи и выведите их построчно на экран. На окончания не обращайте внимание. ВАЖНО!!! Если продукт, который следует заменить написан с большой буквы, то и замена тоже должна начинаться с большой буквы!
// Sample Input:
// 2
...
public class task2_2 {
    public static void main(String[] args) {
        ...
        String str0 = str.replaceAll("арахис", "колбаса");
        String str1 = str0.replaceAll("клубника", "вишня");
        String str2 = str1.replaceAll("сгущенка", "молоко");
        String str3 = str2.replaceAll("Арахис", "Колбаса");
        String str4 = str3.replaceAll("Клубника", "Вишня");
        String str5 = str4.replaceAll("Сгущенка", "Молоко");
